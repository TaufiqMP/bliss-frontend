...
export default function UserProfile({ imageProfile, onImageChange }) {
    return (
        <div className="relative w-full h-60 overflow-visible shadow-md">
            <Image
            ...
            <div className="absolute -bottom-14 left-10">
                <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-lg group">
                    <Image
                        src={imageProfile || `https://cmldqhfeingvkdeurufd.supabase.co/storage/v1/object/public/avatar/default.jpg`}
                        alt="profile"
                        fill
