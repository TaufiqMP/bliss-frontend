...
import { getUsersById, uploadCSV } from "@/utils/api";
                ...
                <main className="flex-1 bg-white">
                    <div className="w-full px-4 py-6 md:px-6 md:py-10">
                        <div className={`${inter.className} leading-tight`}>
                            <p className="text-xl md:text-[24px] text-black font-semibold">
                                {currentGreeting}, admin <span className="text-[#31004A] bg-gray-100 p-1 rounded-md">{name}</span>
                            </p>
...
export default AdminPageWithLayout;
